...
<head>
  ...
  <style>
    ...
    <div class="greet">
        ...
        <div class="diag_port_content">
            <img class="diag_port_icon">
            <strong> <p class="diag_port_num"> PORT {{port}} </p> </strong>
        </div>

        {% for res in result %}
        <div class="cards diag_cards">
            <div class="card diag_card">
                <table>

                    <thead>
                        <tr>
                            <th colspan="2" class="date_card_line"> 
                                <img class="date_icon" src = "{{url_for('static', filename='date_icon.png')}}">
                                <p class="switch_label"> {{ date }} </p>
                            </th>
                        </tr>
                    </thead>
